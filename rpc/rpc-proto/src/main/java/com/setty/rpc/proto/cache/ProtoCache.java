package com.setty.rpc.proto.cache;
...
public class ProtoCache {
    ...
    private static final ConcurrentHashMap<String, ProtoClientServer> CLIENT_SERVER_MAP = new ConcurrentHashMap<>();

    public static void setProtoClientServer(String name, ProtoClientServer protoClientServer) {
        CLIENT_SERVER_MAP.put(name, protoClientServer);
    }

    public static ProtoClientServer getProtoClientServer(String name) {
        return CLIENT_SERVER_MAP.get(name);
    }
